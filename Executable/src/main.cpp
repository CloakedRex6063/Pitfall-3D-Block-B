...
{
	// Create Shader
	const auto basicShader = new Shader("shaders/basic.vert", "shaders/basic.frag");
	Util::SetBasicShader(basicShader);
}

void CreateInstanceShader()
{
	const auto instanceShader = new Shader("shaders/instance.vert", "shaders/instance.frag");
