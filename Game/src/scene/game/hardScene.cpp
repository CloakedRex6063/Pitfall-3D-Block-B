...
#include "character/pitfallCharacter.h"
#include "procGen/proceduralGenerator.h"
...
void HardScene::Init()
{
	...
	proceduralGenerator = new ProceduralGenerator(this,0.4f,0.8f,10);
	proceduralGenerator->GenerateEnemies(50, 200);
	proceduralGenerator->GenerateCoins(30, 200);
}

void HardScene::Tick(float deltaTime)
{
	...
	{
		character->GetComponent<ControllerComponent>()->walkSpeed += 3.f;
