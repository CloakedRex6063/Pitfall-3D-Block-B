...
void MediumScene::Init()
{
	...
	proceduralGenerator = new ProceduralGenerator(this, 0.3f, 0.6f, 10);
	proceduralGenerator->GenerateEnemies(80, 200);
	proceduralGenerator->GenerateCoins(30, 200);
}

void MediumScene::Tick(float deltaTime)
{
	...
	{
		character->GetComponent<ControllerComponent>()->walkSpeed += 2.f;
